...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("changed_fields", postgresql.ARRAY(sa.Text()), nullable=False, server_default="{}"),
        sa.Column("authorization_result", sa.String(32), nullable=False, server_default="allowed"),
