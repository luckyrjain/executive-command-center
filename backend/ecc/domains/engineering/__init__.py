...
framework and source projections).
...
encryption (`crypto.py`) and one deliberately-fake sandbox adapter
(`sandbox_adapter.py`) exercising that contract end to end without a real
network call.

No GitHub/GitLab/Jira adapter, delivery/reliability metric computation,
...
engineering-workspace.md`, matching this task's own explicit scope
boundary: "connector framework and source projections."
"""
