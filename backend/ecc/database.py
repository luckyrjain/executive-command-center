...
# (ecc.platform.idempotency's `held_idempotency_lock`, the one canonical
# implementation an architecture-review deepening consolidated
# ai_runtime/{runtime,evaluation}.py's and personal/ai_insights.py's own
# duplicate copies into -- attention/meeting_prep.py imports it directly too).
