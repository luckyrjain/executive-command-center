    ...
    <>
      ...
      {sections ? (
        <Section
          ...
          items={sections.top_priorities}
          emptyMessage="No ranked priorities need attention."
          variant="panel"
          itemNounSingular="priority"
          itemNounPlural="priorities"
        />
      ) : null}
      ...
      {sections ? (
        <div className="dashboard-grid">
          <Section title="Schedule" items={sections.today_schedule} emptyMessage="No meetings scheduled for today." itemNounSingular="meeting" />
          <Section title="Overdue commitments" items={sections.overdue_commitments} emptyMessage="No overdue commitments." itemNounSingular="overdue commitment" />
          <Section title="Open risks" items={sections.risks} emptyMessage="No active risks." itemNounSingular="risk" />
          <Section
            title="Waiting on"
            items={sections.waiting_on}
            emptyMessage="Nothing is currently blocked on others."
            itemNounSingular="item you're waiting on"
            itemNounPlural="items you're waiting on"
          />
          <Section title="Recent changes" items={sections.recently_changed} emptyMessage="No recent changes." itemNounSingular="change" />
        </div>
      ) : null}
    </>
  )
