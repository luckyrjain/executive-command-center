    ...
    <li>
      ...
      {delegation.status === 'proposed' && isRecipient ? (
        <div className="work-actions">
          <button type="button" className="btn-primary" disabled={actionMutation.isPending} aria-busy={actionMutation.isPending} onClick={() => actionMutation.mutate('accept')}>Accept</button>
